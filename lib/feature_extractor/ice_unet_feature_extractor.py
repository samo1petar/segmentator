...
class IceUNetFE(tf.keras.layers.Layer):
    def __init__(
        ...
        self.cd1 = ConvBnAct(32, 3, name='conv_down_1')
        self.cd2 = ConvBnAct(32, 3, name='conv_down_2')
        self.p1 = MaxPool(name='pool_1')
        self.cd3 = ConvBnAct(64, 3, name='conv_down_3')

        self.ice1 = IceBlock(32, 64, name='ice_down_1')
        self.ice2 = IceBlock(32, 64, name='ice_down_2')

        self.p2 = MaxPool(name='pool_2')
        self.cd4 = ConvBnAct(128, 3, name='conv_down_4')

        self.ice3 = IceBlock(64, 128, name='ice_down_3')
        self.ice4 = IceBlock(64, 128, name='ice_down_4')

        self.p3 = MaxPool(name='pool_3')
        self.cd5 = ConvBnAct(256, 3, name='conv_down_5')

        self.ice5 = IceBlock(64, 256, name='ice_down_5')
        self.ice6 = IceBlock(64, 256, name='ice_down_6')

        self.p4 = MaxPool(name='pool_4')
        self.cd6 = ConvBnAct(384, 3, name='conv_down_6')

        self.ice7 = IceBlock(96, 384, name='ice_down_7')
        self.ice8 = IceBlock(96, 384, name='ice_down_8')
        ...
        self.cu1 = ConvBnAct(384, 3, name='conv_up_1')
        self.ice11 = IceBlock(96, 384, name='ice_up_1')

        self.cu2 = ConvBnAct(256, 3, name='conv_up_2')
        self.ice12 = IceBlock(64, 256, name='ice_up_2')

        self.cu3 = ConvBnAct(128, 3, name='conv_up_3')
        self.ice13 = IceBlock(64, 128, name='ice_up_3')

        self.cu4 = ConvBnAct(64, 3, name='conv_up_4')
        self.ice14 = IceBlock(32, 64, name='ice_up_4')

        self.cu5 = ConvBnAct(32, 3, name='conv_up_5')
        self.cu6 = ConvBnAct(32, 3, name='conv_up_6')
    ...
    def call(self, inputs: tf.Tensor, training: bool = False):
        ...
        x  = self.ice1(x, training=training)
        ...
        x5 = self.ice8(x, training=training)
        x  = self.p5(x5)
